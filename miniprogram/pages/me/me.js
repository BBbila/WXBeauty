...
Page({
  ...
  data: {
   imageUrlBack:"https://6669-firstpro2019-83fpf-1259175764.tcb.qcloud.la/image/reward/backback.jpg?sign=da739c90fdd95fdfc63023145ba0d761&t=1559695963",
    ...
    imageUrlrewardcard:"https://6669-firstpro2019-83fpf-1259175764.tcb.qcloud.la/image/reward/draw.png?sign=d76734284eb563974e5868852bdf3b4a&t=1559723571",
  ...
  click_swiper2: function (e) {
    var url = e.currentTarget.dataset.url

    wx: wx.navigateTo({
      url: "/pages/moving/moving",
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
